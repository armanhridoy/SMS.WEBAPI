...
namespace SMS.WebApi.Service;

public class CommonService<TEntity,IModel>:ICommonRepository<TEntity,IModel>
        where TEntity : class, new() where IModel : class
{
    private readonly IMapper _mapper;
    private readonly ApplicationDB _dbcontext;
    public CommonService(IMapper mapper, ApplicationDB dbcontext)
    {
        _mapper = mapper;
